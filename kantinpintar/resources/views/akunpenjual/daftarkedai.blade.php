...
<body>
    ...
    <form action="actionregisterKedai" method="post">
        @csrf
        <input type="hidden" name="akunPenjualID" value="{{ Auth::guard('akunpenjual')->id() }}">
        ...
        <div class="daftarkan-kedai screen">
            ...
            <div class="group-368">
                <div class="kedai-container">
                    ...
                    <div class="cth-kedai-barokah"><input name="kedaiNama" id="kedaiNama" type="text"
                            placeholder="cth: Kedai Barokah"></div>
                </div>
            </div>
            <img class="group-100" src="{{ URL::asset('image/group-100.png') }}" alt="Group 100" /></span>
            <div class="inputfile">
            ...
            <div class="group-369">
                <div class="kedai-container">
                    ...
                    <div class="cth-kedai-barokah"><input name="kedaiKeterangan" id="kedaiKeterangan" type="text"
            ...
            <div class="group-369">
                <div class="kedai-container">
                    ...
                    <div class="cth-kedai-barokah"><input name="kedaiBuka" id="kedaiBuka" type="text"
                            placeholder="cth: 07.00 WIB"></div>
                </div>
            </div>
            <div class="group-369">
                <div class="kedai-container">
                    <div class="keterangan poppins-normal-black-14px">Waktu Tutup</div>
                    <div class="cth-kedai-barokah"><input name="kedaiTutup" id="kedaiTutup" type="text"
                            placeholder="cth: 17.00  WIB"></div>
                </div>
            </div>
        ...
        <div class="flex-row-1">
            ...
            <div class="group-201">
                <button name="daftar" type="submit" class="daftar-kedai" style="border:none">Daftar Kedai</button>
            </div>
        </div>
        <script>
