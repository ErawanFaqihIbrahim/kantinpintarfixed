<x-akunpembeli-guest-layout>
    ...
    <div class="overlap-group3">
        ...
        <select class="dropdown overlap-group-12" name="test_redirect">
            <option value="akunpembeli/register" class="overlap-group-12" selected>PEMBELI</option>
            <option value="akunpenjual/register" class="overlap-group-12">PENJUAL</option>
        </select>
    ...
    <form method="POST" action="{{ route('akunpembeli.register') }}">
        @csrf
        <div class="login">
            <!-- Email Address -->
