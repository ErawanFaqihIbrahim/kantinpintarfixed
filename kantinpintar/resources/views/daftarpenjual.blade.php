    ...
    <div class="daftarl screen">
        ...
        <div class="overlap-group3">
            ...
            <select class="dropdown overlap-group-12" name="test_redirect">
                <option value="signuppenjual" class="overlap-group-12" selected>PENJUAL</option>
                <option value="signuppembeli" class="overlap-group-12">PEMBELI</option>
            </select>
            <!-- <div class="dropdown dropdown-1">
                <div class="dropdown-default">
                    <div class="penjual">PENJUAL</div>
        ...
        <form action="{{route('actionregisterPenjual')}}" method="post">
            <div class="login">
                @csrf
